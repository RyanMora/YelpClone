...
ActiveRecord::Schema.define(version: 20170530185912) do
  ...
  create_table "search_docs", force: :cascade do |t|
    ...
    t.datetime "created_at",      null: false
    t.datetime "updated_at",      null: false
    t.index ["searchable_type", "searchable_id"], name: "index_search_docs_on_searchable_type_and_searchable_id", using: :btree
  end
